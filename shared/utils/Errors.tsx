 ...
 */
export const countFilingsByError = (filings: any[], hasErrors: boolean): number => {
  return filings.filter((filing) => (hasErrors ? filing.errors.length > 0 : filing.errors.length === 0)).length;
};
