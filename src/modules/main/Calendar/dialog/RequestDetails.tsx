...
//--- Node Modules
import { Flex, Stack, Text, Textarea, TextInput, useMatches } from "@mantine/core";
...
export default function RequestDetails({ opened, onClose, buttonClose }: ModalProps) {
  ...
  return (
    <Modal
      ...
      footer={<Stack className="pt-5 flex flex-row justify-end"></Stack>}>
      <div className="flex flex-col gap-5" style={{ color: "#6D6D6D" }}>
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-2 border-solid border-0.5 border-sky-500 p-4 rounded-lg">
            ...
            <div>
              <Text size="md" bg={statusInfo.color} className="font-medium text-sm lg:text-lg text-white text-center gap-1 rounded-md py-3" />
            </div>
