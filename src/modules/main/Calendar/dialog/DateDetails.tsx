...
import { IconBriefcase, IconClockPlay, IconClockX, IconDeviceMobile, IconFingerprint, IconSquareArrowLeft, IconSquareArrowRight } from "@tabler/icons-react";
...
export default function View({ opened, onClose, buttonClose, date }: ViewInterface) {
  ...
  return (
    <Modal opened={opened} onClose={onClose} centered size={size} buttonClose={buttonClose} title={date}>
      {/* SCHEDULE */}
      ...
      {/* TIME RECORD */}
      <Stack className="flex flex-row justify-between shadow-md shadow-slate-400 w-full h-auto rounded-lg py-3 px-4" onClick={() => setDialog("RequestDetails")}>
