...
export default function Endorse() {
    ...
    return (
        <>
            <Modal opened={action == 'Endorse'} onClose={() => setAction('')} styles={{ title: { color: '#559CDA', fontSize: 22, fontWeight: 600 } }} title={'Endorse Request?'} centered size={modalSize} padding={30}>
