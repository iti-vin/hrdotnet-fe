...
export default function Approve() {
    ...
    return (
        <>
            <Modal zIndex={999999} opened={ACTION == 'Approve'} onClose={() => SET_ACTION('')} styles={{ title: { color: '#559CDA', fontSize: 22, fontWeight: 600 } }} title={'Approve Request?'} centered size={modalSize} padding={30}>
