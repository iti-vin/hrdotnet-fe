...
export default function LeaveTable() {
    ...
    const leaveColumn = [
        { accessor: 'documentNo', title: 'Document No.', textAlign: 'start' },
        {
            ...
            render: ({ transactionDate }: { transactionDate: string }) => {
                return (
                    DateTimeUtils.dayWithDate(transactionDate)
                );
            },
        },
        ...
        {
            accessor: 'leaveFrom', title: 'Leave From', textAlign: 'start',
            render: ({ leaveFrom }: { leaveFrom: string }) => {
                return (
                    DateTimeUtils.dayWithDate(leaveFrom)
                );
            },
        },
        {
            accessor: 'leaveTo', title: 'Leave To', textAlign: 'start',
            render: ({ leaveTo }: { leaveTo: string }) => {
                return (
                    DateTimeUtils.dayWithDate(leaveTo)
                );
            },
        },
        {
        ...
        {
            accessor: 'attachment', title: 'Attachment', textAlign: 'center',
            render: () => {
                return (
                    <div className="flex  justify-center ">
                        <IconFileText className="enlarge" style={iconStyle} onClick={(e) => {
                            e.stopPropagation()
    ...
    const leaveListColumn = [
        ...
        {
            accessor: 'processedBy', title: 'Processed By', textAlign: 'center',
