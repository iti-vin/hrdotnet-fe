...
import useApprovalCosStore from "../../store/approvals";
//--- Services
...
export default function Approval() {
  ...
  const { time, setTime, onBatchApprove, setOnBatchApprove, onBatchCancel, setOnBatchCancel } = useApprovalCosStore();
  ...
  const { data, isLoading, error, refetch } = useQuery<ChangeSchedule>({
    queryKey: ["approval_cos", filter, page],
    queryFn: async () => {
