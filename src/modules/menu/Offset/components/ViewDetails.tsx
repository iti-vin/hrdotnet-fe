...
import { Alerts } from "@/modules/menu/Offset/components/AlertOffset";
import { Buttons } from "@/modules/menu/Offset/components/Button";
...
export default function ViewDetails({ opened, onClose, buttonClose, tabs = "List" }: ModalViewProps) {
  ...
  return (
    <>
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-2  border-solid border-0.5 border-sky-500 p-4 rounded-lg">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-8  sm:gap-9">
                ...
                <Flex direction={{ base: "column", sm: "row" }} justify="space-between" className="w-full" gap={20}>
                  <TimeInput size="lg" radius={8} label="Offset From" className="w-full" disabled styles={{ label: { color: "#6d6d6d", fontSize: "15px" } }} />
                  <TimeInput size="lg" radius={8} label="Offset To" className="w-full" disabled styles={{ label: { color: "#6d6d6d", fontSize: "15px" } }} />
                </Flex>
      ...
      <Alerts opened={dialog} onClose={dialogClose} buttonClose={dialogClose} tabs={tabs} />
    </>
  );
}
