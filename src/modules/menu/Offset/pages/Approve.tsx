...
import { DrawerFilter, Table, ViewDetails } from "@/modules/menu/Offset/components";
...
export default function Approve() {
  ...
  return (
    <Container>
      ...
      <Header title="Offset" buttonLabel="Approve" buttonIcon={<IconCircleCheck size={25} stroke={2} />} />
