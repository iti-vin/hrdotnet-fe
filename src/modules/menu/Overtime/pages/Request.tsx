...
//--- Components(Overtime)
import { NewRequest, ViewDetails, DrawerFilter, Table } from "@/modules/menu/Overtime/components/";
...
export default function Request() {
  ...
  return (
    <Container>
      <Header buttonClick={requestOpen} title="Overtime" buttonLabel="New Request" />
      ...
      <ViewDetails opened={details} onClose={detailsClose} buttonClose={detailsClose} />
    </Container>
  );
}
