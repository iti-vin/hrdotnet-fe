...
export default function index({ total, pageSize, recordsLength, time }: PaginationTypes) {
    ...
    <Group justify={isMobile ? "center" : "space-between"} align="center">
      <Flex>
        <Text size="sm" className="text-gray-500">
          Showing{" "}
          <select className="w-[50px] h-[25px] text-xs border border-gray-300 rounded-md px-1" value={pageSize} onChange={(e) => onHandlePageSize({ PageSize: e.target.value })}>
