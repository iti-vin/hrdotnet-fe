...
export default function ViewDetails({ panel, endorse, approve }: ViewDetailsProps) {
  ...
  return (
    <Modal title="View Details" size="80%" opened={openDialog === "ViewDetails"} onClose={() => setOpenDialog("")} buttonClose={() => setOpenDialog("")}>
              ...
              <div className="flex flex-col gap-8  sm:gap-8">
                <div className="flex flex-col md:flex-row gap-2">
                  <div className="w-full">
                    <DatePickerInput label="Start Date" radius="md" size="lg" placeholder="Start Date" value={new Date(viewItems.filing.dateFiled.dateFrom)} disabled />
                  </div>

                  <div className="w-full">
                    <DatePickerInput label="End Date" radius="md" size="lg" placeholder="End Date" value={new Date(viewItems.filing.dateFiled.dateTo)} disabled />
                  </div>
                </div>
                ...
                <div className="w-full">
                  <TextInput label="Reference Number" radius="md" size="lg" placeholder="00-0000-0000-0000" value={viewItems.filing.referenceNo} disabled />
                </div>
              </div>
            </div>
