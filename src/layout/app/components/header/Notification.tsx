      ...
      <Popover.Dropdown px={0}>
        ...
        <Tabs color="orange" variant="pills" radius="xs" defaultValue="all">
          <Tabs.List grow justify="center" px={10} pb={10}>
            <Tabs.Tab value="all" className="btn-tab">
              All
            </Tabs.Tab>
            <Tabs.Tab value="approved" className="btn-tab">
              Approved
            </Tabs.Tab>
            <Tabs.Tab value="pending" className="btn-tab">
              Pending
            </Tabs.Tab>
            <Tabs.Tab value="reviewed" className="btn-tab">
              Reviewed
            </Tabs.Tab>
          </Tabs.List>
